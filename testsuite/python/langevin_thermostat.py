...
class LangevinThermostat(ut.TestCase):
    ...
    def test_04_1__global_langevin(self):
        """Test for global Langevin parameters for the GronbechJensen-Farago integrator."""
        N = 200
        system = self.system
        system.part.clear()
        system.time_step = 0.06
    ...
    def test_04_2__global_langevin(self):
        """Test for global Langevin parameters for the BAOAB integrator."""
        N = 200
        system = self.system
        system.part.clear()
        system.time_step = 0.06
    ...
    def test_06_1__diffusion(self):
        """This tests rotational and translational diffusion coeff via Green-Kubo
            for the GronbechJensen-Farago integrator"""
        system = self.system
        system.part.clear()
    ...
    def test_06_2__diffusion(self):
        """This tests rotational and translational diffusion coeff via Green-Kubo
            for the BAOAB integrator"""
        system = self.system
        system.part.clear()
    ...
    def verify_diffusion(self, p, corr, kT, gamma):
        ...
        for coord in [1, 2, 3]:
            ...
            self.assertAlmostEqual(ratio, 1., delta=0.18)
