...
cdef class Thermostat(object):
    ...
    def get_state(self):
        ...
        IF BROWNIAN_DYNAMICS:
            if thermo_switch & (THERMO_BROWNIAN | THERMO_ERMAK_BUCKHOLZ
                                ...
                                | THERMO_VGB82 | THERMO_LTID | THERMO_IBD):
                lang_dict = {}
    ...
    IF ERMAK_BUCKHOLZ:
        @AssertThermostatType(THERMO_ERMAK_BUCKHOLZ)
        def set_eb(self, kT=None, gamma=None, gamma_rotation=None,
                         act_on_virtual=False, seed=None):
            """Sets the Ermak-Buckholz thermostat with required parameters 'kT' 'gamma'
            and optional parameter 'gamma_rotation'.
        ...
        @AssertThermostatType(THERMO_LTID)
        def set_long_time_inertial_dyn(self, kT=None, gamma=None, gamma_rotation=None,
                         act_on_virtual=False, seed=None):
            """Sets the Long time-step inertial dynamics thermostat
            (Beard2000)
            with required parameters 'kT' 'gamma'
            and optional parameter 'gamma_rotation'.
            ...
            # allowed
            thermo_switch = (thermo_switch & (~THERMO_LANGEVIN))
            thermo_switch = (thermo_switch | THERMO_LTID)
            mpi_bcast_parameter(FIELD_THERMO_SWITCH)
            return True

        @AssertThermostatType(THERMO_IBD)
        def set_inertial_brownian_dyn(self, kT=None, gamma=None, gamma_rotation=None,
                         act_on_virtual=False, seed=None):
            """Sets the Inertial Brownian Dynamics thermostat
            (Beard2000)
            with required parameters 'kT' 'gamma'
            and optional parameter 'gamma_rotation'.
            ...
            # allowed
            thermo_switch = (thermo_switch & (~THERMO_LANGEVIN))
            thermo_switch = (thermo_switch | THERMO_IBD)
            mpi_bcast_parameter(FIELD_THERMO_SWITCH)
            return True
    
    IF LANGEVIN_IMPULSE:
        @AssertThermostatType(THERMO_LI)
        def set_langevin_impulse(self, kT=None, gamma=None, gamma_rotation=None,
                         act_on_virtual=False, seed=None):
            """Sets the Langevin-Impulse thermostat with required parameters 'kT' 'gamma'
            and optional parameter 'gamma_rotation'.
            ...
            # allowed
            thermo_switch = (thermo_switch & (~THERMO_LANGEVIN))
            thermo_switch = (thermo_switch | THERMO_LI)
            mpi_bcast_parameter(FIELD_THERMO_SWITCH)
            return True

        @AssertThermostatType(THERMO_VGB82)
        def set_vanGunsteren_Berendsen(self, kT=None, gamma=None, gamma_rotation=None,
                         act_on_virtual=False, seed=None):
            """Sets the van Gunsteren-Berendsen thermostat with required parameters 'kT' 'gamma'
            and optional parameter 'gamma_rotation'.
            ...
            # allowed
            thermo_switch = (thermo_switch & (~THERMO_LANGEVIN))
            thermo_switch = (thermo_switch | THERMO_VGB82)
            mpi_bcast_parameter(FIELD_THERMO_SWITCH)
            return True
