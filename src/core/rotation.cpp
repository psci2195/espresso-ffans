...
void propagate_omega_quat_particle(Particle *p) {
  ...
  if (thermo_switch & (THERMO_BROWNIAN | THERMO_ERMAK_BUCKHOLZ | THERMO_EB_VELPOS | THERMO_LI))
    return;
...
void convert_torques_propagate_omega() {
  ...
  for (auto &p : local_cells.particles()) {
    ...
    } else if (!(thermo_switch & (THERMO_ERMAK_BUCKHOLZ | THERMO_EB_VELPOS | THERMO_LI))) //{
